...
![Termos de "data" em um fluxo de processo de Ciência de Dados.[^1]](data-terms%202.png){fig-align="center"}
...
**Data Lake:** Um repositório de armazenamento que contém uma grande quantidade de dados brutos em seu formato natural.

**Delta Lake:** Delta Lake é um projeto de código aberto que proporciona confiabilidade aos Data Lakes. Ele faz isso fornecendo um novo armazenamento em camadas que traz ACID (Atomicidade, Consistência, Isolamento, Durabilidade) para grandes conjuntos de dados e o suporte para operações de leitura e gravação em escala de petabytes. Isso é particularmente útil para lidar com Big Data, onde os dados estão em formatos e volumes diferentes.
